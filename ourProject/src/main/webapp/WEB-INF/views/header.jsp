    ...
    <header class="container" style="height:150px;">
        <div class="text-center fixed-top bg-light py-3">
            ...
            <nav class="nav justify-content-center">
                ...
                <a class="nav-link" href="/ourProject/calendar">일정 관리</a>
                <a class="nav-link" href="/ourProject/emergencys">응급실 관리</a>
                <a class="nav-link" href="/ourProject/products">출산/육아용품 관리</a>
                <a class="nav-link" href="/ourProject/diarys">성장일기</a>
                <a class="nav-link" href="/ourProject/map">지도</a>
            </nav>
        </div>
    </header>
